  ...
  return (
    <div className="polaroid bg-white dark:bg-ink-800 p-6 mb-6 -rotate-1">
      ...
      <div className="flex justify-center gap-4 mb-4">
        ...
        >
          {/* Reuses the up-vote glyph rotated 180° instead of a separate
              "thumbs down" path — that hand-drawn path didn't mirror the
              up icon cleanly and rendered as a distorted blob. */}
